...
export default function MyAssignmentsPage() {
  ...
  const calculateDaysWithTerritory = (assignedAt: string | null): number => {
  ...
  const handleConfirmComplete = async () => {
    ...
    try {
      // Atualizar o território para status 'completed'
      ...
      // Atualizar o assignment correspondente
      ...
      console.error("Erro ao concluir território:", error?.message || error)
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {territories.map((territory) => {
          ...
          const days = calculateDaysWithTerritory(territory.last_assigned_at)
